...
STARTING_MELODY = [["C6", "D6", "E6", "F6", "G6", "A6", "B6", "C7", "C6", "D6", "E6", "F6", "G6", "A6", "B6", "C7"],[4, 4, 4, 4, 4, 4, 4, 32, 4, 4, 4, 4, 4, 4, 4, 32], 0.01, 0.9]
STANDBY_MELODY = [["G6", "E6", "E6", "D6", "E6", "G6"],[8, 8, 16, 8, 8, 8], 0.015, 0.7]
WORKING_MELODY = [["E6", "G6", "A6", "A6", "A6", "B6", "C7", "C7", "C7", "D7", "B6", "B6", "A6", "G6", "G6", "A6"], [8, 8, 16, 16, 8, 8, 16, 16, 8, 8, 16, 16, 8, 8, 8, 16], 0.018, 0.7]
